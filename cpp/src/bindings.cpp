...
void bind_matrix_funcs(py::module &m) {
    ...
    m.def("EvalMatMulSquare",
          static_cast<Ciphertext (*)(CryptoContext &, const PublicKey &, const Ciphertext &, const Ciphertext &,
...
//         .def(py::init<const A &>())
//         .def(
//             "__add__", [](const Ciphertext<DCRTPoly> &a, const Ciphertext<DCRTPoly> &b) { return a + b; },
