...
std::vector<double> GenTauDiag(const int32_t total_slots,
                               const int32_t row_size, const int32_t k) {
  int32_t n = row_size * row_size;
...
diagonal
*/
std::vector<double> GenPhiDiag(const int32_t row_size, const int32_t k,
                               const int type) {
  int32_t n = row_size * row_size;
  std::vector<double> diag(n, 0);
...
std::vector<double> GenTransposeDiag(const int32_t total_slots,
                                     const int32_t row_size, const int32_t i) {
  int32_t n = row_size * row_size;
  std::vector<double> diag(total_slots, 0);
  for (auto t = 0; t < total_slots / n; t++) {
    if (i >= 0) {
