...
inline std::vector<std::vector<double>> MulMats(
...
inline std::vector<double> MulMatVec(std::vector<std::vector<double>> mat,
...
inline std::vector<double> RandVec(const int n, const int modulus = 5,
